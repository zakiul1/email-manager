<div x-data="{ activeTab: 'preview' }" class="space-y-6 p-6">
    <section class="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
        <div>
            <h1 class="text-2xl font-semibold tracking-tight text-zinc-950 dark:text-white">Template Preview</h1>
    ...
    <section x-show="activeTab === 'html-source'" x-cloak class="border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <pre class="mt-4 overflow-x-auto border border-zinc-200 bg-zinc-100 p-4 text-xs text-zinc-800 dark:border-zinc-700 dark:bg-zinc-950 dark:text-zinc-200"><code>{{ $template->html_content }}</code></pre>
    </section>
</div>