            ...
            @if(in_array($status, ['processing','done','error','cancelled'], true))
                ...
                ">
                    <div class="flex items-start justify-between gap-3">
                        <div>
                            ...
                            <div class="mt-1 text-xs text-muted-foreground">
                                Progress: <span class="font-semibold">{{ $processed }}</span> / <span class="font-semibold">{{ $total }}</span>
                    ...
                    <div class="mt-3 h-2 w-full rounded bg-white/60 overflow-hidden border">
                        <div class="h-2 bg-foreground/60" style="width: {{ $percent }}%"></div>
                    </div>
        ...
        <form class="mt-6 space-y-5" wire:submit.prevent="submit">
            ...
            <div class="space-y-2">
                ...
                <div class="flex gap-2">
                    <select
                        wire:key="categories-select-{{ $categoriesVersion }}"
